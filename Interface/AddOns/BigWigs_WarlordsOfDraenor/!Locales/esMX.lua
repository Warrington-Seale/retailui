...
local L = BigWigs:NewBossLocale("Gruul", "esMX")
if L then
	L.first_ability = "Machaque o Embate"
end

L = BigWigs:NewBossLocale("Oregorger", "esMX")
if L then
	L.roll_message = "Rueda %d - %d cajas para acabar!"
end

L = BigWigs:NewBossLocale("The Blast Furnace", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Flamebender Ka'graz", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Kromog", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Beastlord Darmac", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Operator Thogar", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Iron Maidens", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Blackhand", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Blackrock Foundry Trash", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Supreme Lord Kazzak", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Hellfire Assault", "esMX")
if L then
	L.left = "Izquierda: %s"
	L.middle = "Centro: %s"
	L.right = "Derecha: %s"
...
L = BigWigs:NewBossLocale("Socrethar the Eternal", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Fel Lord Zakuun", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Tyrant Velhari", "esMX")
if L then
	L.font_removed_soon = "¡Tu Fuente acaba pronto!"
end

L = BigWigs:NewBossLocale("Mannoroth", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Archimonde", "esMX")
if L then
	L.chaos_bar = "%s -> %s"
	L.chaos_from = "%s de %s"
...
L = BigWigs:NewBossLocale("Hellfire Citadel Trash", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Kargath Bladefist", "esMX")
if L then
...
L = BigWigs:NewBossLocale("The Butcher", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Tectus", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Brackenspore", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Twin Ogron", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Ko'ragh", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Imperator Mar'gok", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Highmaul Trash", "esMX")
if L then
