...
local lootCurrency = {
	...
	[43228] = "Stone Keeper's Shards",
	[43589] = "Wintergrasp Mark of Honor",
	[44990] = "Champion's Seal",
	--[] = "Sidereal Essence", --Only a currency not an item?
...
local lockoutBossQuests = {
	...
	[33117] = {
		name = WORLD_BOSS_FOUR_CELESTIALS,
		difficultyName = L["World Boss"],
		--journalEncounterID = 0, --They have 4 seperate ids for each boss but same lockout.
	},
	[33118] = {
		name = L["Ordos"],
		difficultyName = L["World Boss"],
	...
	[42270] = {
		...
		difficultyName = L["World Boss"],
		--journalEncounterID = 0, --Don't get name from dung journal for these shared ones, test stuff if/when legion comes.
	},
	[42779] = {
