...
function API:RefreshCooldownManager()
    C_Timer.After(0.01, function()
        ...
        if ns.EditModeHelp and ns.EditModeHelp.ApplyConfiguredNativeAnchors then
            ns.EditModeHelp:ApplyConfiguredNativeAnchors()
        end
        if ns.EditModeHelp and ns.EditModeHelp.PreviewNativeViewerAnchors then
            -- Preview only for helper-owned positions. Configured CMC anchors
            -- are enforced directly above and never written into Edit Mode.
