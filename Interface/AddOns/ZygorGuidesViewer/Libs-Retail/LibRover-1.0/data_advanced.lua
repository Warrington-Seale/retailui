...
data.basenodes.advanced = {
	...
	{"REGION",name="tci_vault_corridor",mapzone="The Coiled Isle",zonematch="*/*/*/Vaults of Atal'Utek", in_flight=true},

}

data.cantrips = {
	[53822] = {maps={647,648,646},id="deathgate_exit"}, -- 50977 is the spell thatn spawns the gate, but 53822 is the actual transfer
	[126892] = {maps={709},id="zenpilgrimage_exit"},
	--[1255801] = {maps={2541},id="arcantina_exit"}, -- 12.0.7 - arcantina portals are static
}