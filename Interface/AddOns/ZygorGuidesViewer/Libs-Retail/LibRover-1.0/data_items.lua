...
data.portkeys = { -- smile if you're a muggle
	...
	-- Key to the Arcantina
		{item=253629, toy=true, destination="Arcantina/0 50.61,88.88", cost=15, cooldown=90}, -- world to arcantina -- , cond=function() return ZGV.CurrentMapID~=2541 end
		--{item=253629, toy=true, destination="@arcantina_exit", cost=15, cooldown=90, cond=function() return IsQuestFlaggedCompleted(86903) and LibRover.Cantrips:Ready(1255801) end}, -- arcantina to world, destination is dynamic. 12.0.7 no longer
