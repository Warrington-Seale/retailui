...
-- Midnight
	...
	-- Western connection
	-- world to tunnel
	"The Coiled Isle/0 31.87,64.88 <border_in_flight:true> <radius:20> -x- The Coiled Isle/0 31.91,64.87  <region:tci_vault_corridor>  <border_in_flight:true> <radius:20> {title_atob:Enter the tunnel} {title_btoa:Exit the tunnel} {cost:48}",
	-- tunnel to inside
	"The Coiled Isle/0 35.69,67.54 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> -to- Vaults of Atal'Utek/0 42.43,89.80 <border_in_flight:true> <radius:20> {title:Follow the tunnel} {cost:48}",
	-- inside to tunnel
	"Vaults of Atal'Utek/0 38.48,82.87 <border_in_flight:true> <radius:20> -to- The Coiled Isle/0 34.22,64.90 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> {title:Follow the tunnel} {cost:48}",

	-- Northern connection
	-- world to tunnel
	"The Coiled Isle/0 43.30,44.27 <border_in_flight:true> <radius:5> -x- The Coiled Isle/0 43.28,44.20 <region:tci_vault_corridor>  <border_in_flight:true> <radius:20> {title_atob:Enter the tunnel} {title_btoa:Exit the tunnel} {cost:48}",
	-- tunnel to inside
	"The Coiled Isle/0 39.06,41.54 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> -to- Vaults of Atal'Utek/0 58.36,36.10 <border_in_flight:true> <radius:20> {title:Follow the tunnel} {cost:48}",
	-- inside to tunnel
	"Vaults of Atal'Utek/0 63.26,43.23 <border_in_flight:true> <radius:20> -to- The Coiled Isle/0 40.57,44.09 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> {title:Follow the tunnel} {cost:48}",
	
	-- Eastern connection
	-- world to tunnel
	"The Coiled Isle/0 45.37,64.90 <border_in_flight:true> <radius:20> -x- The Coiled Isle/0 45.37,64.90  <region:tci_vault_corridor>  <border_in_flight:true> <radius:20> {title_atob:Enter the tunnel} {title_btoa:Exit the tunnel} {cost:48}",
	-- tunnel to inside
	"The Coiled Isle/0 41.07,62.27 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> -to- Vaults of Atal'Utek/0 51.24,82.08 <border_in_flight:true> <radius:20> {title:Follow the tunnel} {cost:48}",
	-- inside to tunnel
	"Vaults of Atal'Utek/0 55.92,89.26 <border_in_flight:true> <radius:20> -to- The Coiled Isle/0 42.66,64.87 <border_in_flight:true> <region:tci_vault_corridor> <radius:20> {title:Follow the tunnel} {cost:48}",
