...
data.basenodes.FloorCrossings = --[[LIBROVER]] {
	...
	-- MIDNIGHT
		...
		["The Coiled Isle"] = {
			"The Coiled Isle/0 45.48,75.78 <radius:10> -x- Crypt of the Denied/0 69.16,18.00 <radius:7>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"The Coiled Isle/0 74.71,62.70 <radius:10> -x- Crypt of the Disgraced/0 66.44,17.99 <radius:7>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"The Coiled Isle/0 45.37,64.93 <radius:10> -x- Vaults of Atal'Utek/0 51.29,82.10 <radius:10>"..
				"{title_atob:Enter the vault} {title_btoa:Leave the vault}",
			"The Coiled Isle/0 44.78,30.06 <radius:10> -x- Infested Tomb/0 76.66,41.25 <radius:10>"..
				"{title_atob:Enter the tomb} {title_btoa:Leave the tomb}",
			"The Coiled Isle/0 44.68,34.45 <radius:10> -x- Kin's Rest/0 78.59,41.39 <radius:10>"..
				"{title_atob:Enter the tomb} {title_btoa:Leave the tomb}",
			"The Coiled Isle/0 52.95,32.23 <radius:10> -x- Crypt of the Lost Warrior/0 7.64,59.34 <radius:10>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"The Coiled Isle/0 57.09,33.45 <radius:10> -x- Crypt of the Lost Warrior/0 89.42,82.69 <radius:10>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"The Coiled Isle/0 49.46,38.54 <radius:10> -x- Crypt of the Lost Mason/0 45.44,11.99 <radius:10>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"The Coiled Isle/0 52.42,43.00 <radius:10> -x- Tomb of the Lost Priest/0 52.20,79.92 <radius:10>"..
				"{title_atob:Enter the tomb} {title_btoa:Leave the tomb}",
		},

		["Vaults of Atal'Utek"] = {
			"Vaults of Atal'Utek/0 39.47,48.22 <radius:10> -x- Vault of Restless Bones/0 78.95,42.07 <radius:10>"..
				"{title_atob:Enter the vault} {title_btoa:Leave the vault}",
			"Vaults of Atal'Utek/0 47.23,7.28 <radius:10> -x- Atal'Utek Underbelly/0 52.43,87.13 <radius:10>"..
				"{title_atob:Enter the building} {title_btoa:Leave the building}",
			"Vaults of Atal'Utek/0 54.92,48.13 <radius:10> -x- Profaned Mausoleum/0 18.30,59.99 <radius:10>"..
				"{title_atob:Enter the crypt} {title_btoa:Leave the crypt}",
			"Vaults of Atal'Utek/0 39.32,39.92 <radius:10> -x- Ruuk'Jar's Clutch/0 84.12,41.15 <radius:10>"..
				"{title_atob:Click the Clutch Portal} {title_btoa:Click the Exit Portal}",
		},
