...
---------------------
	...
	----------------------------
		...
		---------------------------
			...
			--## Neutral ##--
				...
				"Silvermoon City M/0 47.93,51.95 -to- The Lycaneum/0 56.46,14.00 {fac:B} {mode:PORTAL} {title:Click the Portal to Magisters Terrace}"..
				"{cond:PlayerCompletedQuest(96233)}",

				"The Lycaneum/0 55.86,11.64 -to- Silvermoon City M/0 52.85,65.51 {fac:B} {mode:PORTAL} {title_:Click the Portal to Silvermoon City}"..
				"{cond:PlayerCompletedQuest(96233)}",
					
				-- Silvermoon City -to- The Coiled Isle
					"Silvermoon City M/0 56.88,67.48 -x- The Coiled Isle/0 58.17,48.48 {mode:PORTAL}"..
					"{title_atob:Click the Portal to the\nCoiled Isle Inside the\nbuilding} {title_btoa:Click the Portal to Astalor's Sanctum}"..
					"{cond:PlayerCompletedQuest(96525) or PlayerIsOnQuest(96525)}",
		...
		---------------------
			...
			--## Neutral ##--
				-- Arcantina -to- Silvermoon City
					--"Silvermoon City M/0 45.66,69.73 @arcantina_exit <onlyhardwire_to:true>", -- dynamic, gets updated when key is used. 12.0.7 no longer used, exit is static to silvermoon

					"Arcantina/0 50.61,88.88 -to- Silvermoon City M/0 56.36,70.75 {mode:PORTAL}".. 
		...
		--------------------------
			...
			"Player House/0 1,1 -x- @player_house_horde {mode:PORTAL} {title_atob:Leave your house} {title_btoa:Enter your house} {fac:H}",
			"Player House/0 1,1 -x- @player_house_alliance {mode:PORTAL} {title_atob:Leave your house} {title_btoa:Enter your house} {fac:A}",
	...
	--## Neutral ##--
		...
		-- The Timeways -to- Zuldazar (Mount Mugamba)
		"Millenia's Threshold/0 74.37,47.14 -to- Zuldazar/0 43.68,45.43 {mode:PORTAL} {title:Click the portal to Mount Mugamba (King's Rest)}",

		-- The Timeways -to- The Waking Shores (Flashfront Assault)
		"Millenia's Threshold/0 77.26,61.60 -to- The Waking Shores/0 58.04,78.40 {mode:PORTAL} {title:Click the portal to Flashfront Assault (Ruby Life Pools)}",

		-- The Timeways -to- Vol'dun (Algeth'ar Academy)
		"Millenia's Threshold/0 70.44,72.72 -to- Vol'dun/0 50.92,38.22 {mode:PORTAL} {title:Click the portal to Vol'dun (Temple of Sethraliss)}",
	...
	--## ALLIANCE ##--
		...
		"Tanaris/17 58.20,26.69 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
	...
	--## HORDE ##--
		...
		"Tanaris/17 58.97,26.78 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar}",
...
------------------
		...
		-- DEATHKNIGHT
			"Broken Shore/2 27.43,30.43 <spell:50977> <subtype:deathgate> <cond:(PlayerCompletedQuest(38990) or PlayerCompletedQuest(40935) or PlayerCompletedQuest(40740)) and not (ZGV.CurrentMapID==647 or ZGV.CurrentMapID==648  or ZGV.CurrentMapID==646)>",
			"Broken Shore/2 27.43,30.43  @deathgate_exit <onlyhardwire_to:true> <spell:50977> <subtype:deathgate> <cond:(PlayerCompletedQuest(38990) or PlayerCompletedQuest(40935) or PlayerCompletedQuest(40740)) and LibRover.Cantrips:Ready(53822)>", -- dynamic, gets updated when key is used. 53822 is the actuall transfer spell, 50977 only spawns the gate
		...
		-- MONK (Zen Pilgrimage)
			...
			"The Wandering Isle L/0 51.46,48.65 @zenpilgrimage_exit <onlyhardwire_to:true> <spell:126892> <subtype:zenpilgrimage> <cond:PlayerCompletedQuest(40236) and LibRover.Cantrips:Ready(126892)>", -- dynamic, gets updated when key is used
