...
-- DUNGEON ENTRANCE/EXITS --
	...
	----------------
		...
		-- Altar of Fangs --
		"Vaults of Atal'Utek/0 47.24,68.55 -x- Altar of Fangs/0 48.95,18.11 {autotype:portal_dungeon}",
...
-- RAID ENTRANCE/EXITS --
	...
	----------------
		...
		"The Coiled Isle/0 59.57,66.33 -x- The Tidebound Grotto/0 26.11,26.36 {autotype:portal_dungeon}",

		-- The Venomous Abyss --
		"Vaults of Atal'Utek/0 47.25,20.51 -x- The Venomous Abyss/0 49.78,94.15 {autotype:portal_dungeon}",
...
-- DELVE ENTRANCE/EXITS
	...
	----------------
		...
		-- Gnarldor Isle --
		"The Coiled Isle/0 64.40,77.79 -x- Gnarldor Isle/0 77.03,46.37 {autotype:portal_dungeon} {title_atob:Click Enter Delve to Enter\nGnarldor Isle} {title_btoa:Enter the Portal to Leave Gnarldor Isle}",

		--Venomfall Deeps --
		"The Coiled Isle/0 51.23,30.26 -x- Venomfall Deeps/0 50.02,94.76 {autotype:portal_dungeon} {title_atob:Click Enter Delve to Enter\nVenomfall Deeps} {title_btoa:Enter the Portal to Leave Venomfall Deeps}",
}
...
-- DUNGEON FLOORS --
	...
	----------------
		...
		-- Altar of Fangs --
		["Altar of Fangs"] = {
			"Altar of Fangs/0 49.07,90.03 -x- Altar of Fangs/1 43.69,12.27",
			"Altar of Fangs/1 67.72,62.84 -x- Altar of Fangs/2 62.94,62.59",
		},
...
-- RAID FLOORS --
	...
	----------------
		...
		-- The Venomous Abyss--
		["The Venomous Abyss"] = {
			"The Venomous Abyss/0 50.00,14.50 -x- The Venomous Abyss/1 49.98,90.66",
			"The Venomous Abyss/1 57.63,63.76 -x- The Venomous Abyss/2 27.19,32.64",
			"The Venomous Abyss/1 42.32,63.59 -x- The Venomous Abyss/3 79.08,33.54",
			"The Venomous Abyss/1 49.92,46.83 -x- The Venomous Abyss/4 49.55,93.08",
		},
