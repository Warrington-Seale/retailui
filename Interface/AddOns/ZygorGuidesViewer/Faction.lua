...
local reptypes = {  -- OVERRIDDEN in Classic/WOTLK
	...
	['delvecompanion'] = {
		standings = {
			{ name="Level 1",	from=0      ,	color="ffff00"},
			{ name="Level 2",	from=2500   ,	color="fefd03"},
			{ name="Level 3",	from=5500   ,	color="fefc06"},
			{ name="Level 4",	from=9100   ,	color="fdfa0a"},
			{ name="Level 5",	from=13420  ,	color="fcf90d"},
			{ name="Level 6",	from=18604  ,	color="fcf710"},
			{ name="Level 7",	from=24824  ,	color="fbf613"},
			{ name="Level 8",	from=32290  ,	color="faf417"},
			{ name="Level 9",	from=41248  ,	color="faf31a"},
			{ name="Level 10",	from=51997  ,	color="f9f11d"},
			{ name="Level 11",	from=64497  ,	color="f9f020"},
			{ name="Level 12",	from=76997  ,	color="f8ee24"},
			{ name="Level 13",	from=89497  ,	color="f7ed27"},
			{ name="Level 14",	from=101997 ,	color="f7eb2a"},
			{ name="Level 15",	from=114497 ,	color="f6ea2d"},
			{ name="Level 16",	from=133247 ,	color="f5e830"},
			{ name="Level 17",	from=151997 ,	color="f5e734"},
			{ name="Level 18",	from=170747 ,	color="f4e537"},
			{ name="Level 19",	from=189497 ,	color="f3e43a"},
			{ name="Level 20",	from=208247 ,	color="f3e23d"},
			{ name="Level 21",	from=226997 ,	color="f2e141"},
			{ name="Level 22",	from=245747 ,	color="f1df44"},
			{ name="Level 23",	from=264497 ,	color="f1de47"},
			{ name="Level 24",	from=283247 ,	color="f0dc4a"},
			{ name="Level 25",	from=301997 ,	color="f0db4d"},
			{ name="Level 26",	from=351997 ,	color="efd951"},
			{ name="Level 27",	from=401997 ,	color="eed854"},
			{ name="Level 28",	from=451997 ,	color="eed657"},
			{ name="Level 29",	from=501997 ,	color="edd55a"},
			{ name="Level 30",	from=551997 ,	color="ecd35e"},
			{ name="Level 31",	from=601997 ,	color="ecd261"},
			{ name="Level 32",	from=651997 ,	color="ebd064"},
			{ name="Level 33",	from=701997 ,	color="eacf67"},
			{ name="Level 34",	from=751997 ,	color="eacd6b"},
			{ name="Level 35",	from=801997 ,	color="e9cc6e"},
			{ name="Level 36",	from=901997 ,	color="e8ca71"},
			{ name="Level 37",	from=1001997,	color="e8c974"},
			{ name="Level 38",	from=1101997,	color="e7c777"},
			{ name="Level 39",	from=1201997,	color="e6c67b"},
			{ name="Level 40",	from=1301997,	color="e6c47e"},
			{ name="Level 41",	from=1401997,	color="e5c381"},
			{ name="Level 42",	from=1501997,	color="e5c184"},
			{ name="Level 43",	from=1601997,	color="e4c088"},
			{ name="Level 44",	from=1701997,	color="e3be8b"},
			{ name="Level 45",	from=1801997,	color="e3bd8e"},
			{ name="Level 46",	from=1926997,	color="e2bb91"},
			{ name="Level 47",	from=2051997,	color="e1ba94"},
			{ name="Level 48",	from=2176997,	color="e1b898"},
			{ name="Level 49",	from=2301997,	color="e0b79b"},
			{ name="Level 50",	from=2426997,	color="dfb59e"},
			{ name="Level 51",	from=2551997,	color="dfb4a1"},
			{ name="Level 52",	from=2676997,	color="deb2a5"},
			{ name="Level 53",	from=2801997,	color="ddb1a8"},
			{ name="Level 54",	from=2926997,	color="ddafab"},
			{ name="Level 55",	from=3051997,	color="dcaeae"},
			{ name="Level 56",	from=3239497,	color="dbacb2"},
			{ name="Level 57",	from=3426997,	color="dbabb5"},
			{ name="Level 58",	from=3614497,	color="daa9b8"},
			{ name="Level 59",	from=3801997,	color="daa8bb"},
			{ name="Level 60",	from=3989497,	color="d9a6be"},
			{ name="Level 61",	from=4176997,	color="d8a5c2"},
			{ name="Level 62",	from=4364497,	color="d8a3c5"},
			{ name="Level 63",	from=4551997,	color="d7a2c8"},
			{ name="Level 64",	from=4739497,	color="d6a0cb"},
			{ name="Level 65",	from=4926997,	color="d69fcf"},
			{ name="Level 66",	from=5176997,	color="d59dd2"},
			{ name="Level 67",	from=5426997,	color="d49cd5"},
			{ name="Level 68",	from=5676997,	color="d49ad8"},
			{ name="Level 69",	from=5926997,	color="d399db"},
			{ name="Level 70",	from=6176997,	color="d297df"},
			{ name="Level 71",	from=6426997,	color="d296e2"},
			{ name="Level 72",	from=6676997,	color="d194e5"},
			{ name="Level 73",	from=6926997,	color="d193e8"},
			{ name="Level 74",	from=7176997,	color="d091ec"},
			{ name="Level 75",	from=7426997,	color="cf90ef"},
			{ name="Level 76",	from=7739497,	color="cf8ef2"},
			{ name="Level 77",	from=8051997,	color="ce8df5"},
			{ name="Level 78",	from=8364497,	color="cd8bf9"},
			{ name="Level 79",	from=8676997,	color="cd8afc"},
			{ name="Level 80",	from=8989497,	color="cc88ff"},
		},
		check = function(id,fid,ftex)
			return fid==2744
		end
	...
	['captaintokka'] = {
		standings = {
			{ name="Stranger", from=0, color="ffff00"},
			{ name="Doomed Sailor", from=100, color="00ff00"},			
			{ name="Cursed Angler", from=2700, color="00ff88" },
			{ name="Venom Trawler", from=5300, color="00ffff" },
			{ name="Bloodsworn Crew", from=8400, color="44ddff" },
			{ name="Best Friend", from=5*8400, color="cc88ff" },
		},
		check = function(id,fid,ftex)
			return fid==2773
