...
-----------------------------------------------------------------------------------------------------------------
	...
	["stepgoal_havebuff"] = "Gain '%s' Buff/Debuff",
	["stepgoal_havebuff_count"] = "Gain %d %s of '%s' Buff/Debuff", -- second param is plural(stepgoal_havebuff_stack)
	["stepgoal_havebuff_stack"] = "stack",
	...
	["stepgoal_learnpetspell"] = "Teach your pet %s Spell",
	...
	["stepgoal_stablemaster"] = "Stable your pet with %s", 
	["stepgoal_stablemaster_done"] = "Stabled the pet with %s", 
		--stepgoal_walk
		--stepgoal_webheader
		--stepgoal_webimage
		--stepgoal_webinfo
...
-----------------------------------------------------------------------------------------------------------------
	...
	-- Home screen widgets ---------------------------------------------------------------------------------------------------
		...
		widget_bountifuldelves_name = "Delves",
		widget_bountifuldelves_description = "Displays current Bountiful Delves, and stories progress",
		widget_bountifuldelves_empty = "No Bountiful Delves active",
		widget_bountifuldelves_locked = "Bountiful Delves requires max level",
		widget_bountifuldelves_stories_header = "Delves Stories progress",

		widget_locations_name = "Locations",
		widget_locations_description = "Displays players favorite locations",
		widget_locations_empty = "No locations saved. Use + button to save current position",
		widget_locations_recordtooltip = "Record current position",
		widget_locations_recorderrename = "Position recorded. You can rename it using Locations widget",
		widget_locations_header = "Locations",
}
-----------------------------------------------------------------------------------------------------------------
-- colour coding ------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------
