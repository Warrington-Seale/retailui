...
step
In order to earn this achievement you will _need to have_ the Sparring Arena built in Gorgrond
|tip You can swap out your building if you wish, or do this on an alt as the achievement is account wide.
|tip You will need to use the special action button, Champion's Honor, before killing the mobs for this achievement. The Arena Champion must be present for the items to drop.
|confirm
step
