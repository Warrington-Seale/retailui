...
collect 4 Mighty Mammoth Ribs##197747 |n
...
|tip They also appear at random.
talk Pathfinder Jeb##187700
buy Small Expedition Shovel##191294 |goto The Waking Shores/0 47.33,83.39 |n
|tip These only have 5 charges, so you will need several.
use A Guide to Rare Fish##199061 |only if not completedq(70527)
Read A Guide to Rare Fish |q 70527 |future |only if not completedq(70527) |next "Bubble_Drifter" |or
use the Nokhud Armorer's Notes##194540 |only if not completedq(67046)
...
step
Ellam |achieve 16424/6 |goto Ohn'ahran Plains/0 76.68, 30.5
step
...
step
Use the /love Emote on a "Crimson Knocker" |achieve 16729/9 |goto The Azure Span/0 28.89,41.94
...
Select _"<I have been honored by a cunning panther spirit.>"_ |gossip 114125
click Boon of Ashamane##411065
Discover the "Reliquary of Ashmane" Treasure |achieve 19317/9 |goto Barrows of Reverie/0 63.31,35.09
]])
...
|tip She moves with the Dreamsurge Camp which could be anywhere in the main Dragon Isles zones.
...
step
Collect the Dragon Glyph: Froststone Vault |achieve 17411/3 |goto The Forbidden Reach/5 62.54,32.43 |notravel
