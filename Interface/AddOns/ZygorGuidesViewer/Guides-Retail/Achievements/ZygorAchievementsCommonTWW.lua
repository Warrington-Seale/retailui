...
step
achieve 42740/8 |goto K'aresh/0 64.47,47.55
step
...
step
achieve 42740/6 |goto K'aresh/0 58.14,23.06
step
achieve 42740/5 |goto K'aresh/0 50.11,23.10
step
achieve 42740/4 |goto K'aresh/0 50.35,36.35
]])
...
'|achieve 40705/4 |or
step
Fly Through the Skyriding Glyph: Old Sacrificial Pit |goto Nerub'ar/1 13.29,32.97
...
step
Collect the Skyriding Glyph: Tazavesh, the Veiled Market |achieve 42727/7 |goto Tazavesh/0 55.11,67.56
...
'|achieve 40625/14 |or
step
clicknpc Moog##225421 |goto Hallowfall/0 69.27,43
|tip Inside the building.
Click Here to Continue |confirm |next |or
'|achieve 40625/5 |or
step
...
step
|tip This battle pet can be found in Azj-Kahet.
click Black Blood Extractor |goto Azj-Kahet/1 60.34,80.93 |havebuff spell:420847
|tip You need the _Unseeming Shift_ debuff to see this battle pet.
...
|confirm
step
|tip _Right click_ off your Phase Diving buff.
...
achieve 42741/9 |goto K'aresh/0 74.73,55.37
step
...
|tip _Right click_ off your Phase Diving buff.
|tip This is one of four possible locations.
...
step
|tip _Right click_ off the Phase Diving buff to fly back to this Phase Conduit.
Use the Phase Conduit
Gain the "Phase Diving" Buff |complete hasbuff("spell:1214374") |goto Tazavesh/0 46.94,57.09
|tip Inside the building on Tazavesh.
step
...
|tip Use it on the Pearlescent Shellcrab in the future steps.
Click Here to Continue |confirm |achieve 40434/1 |goto Isle of Dorn/0 48.59,30.04
step
clicknpc Pearlescent Shellcrab##224548
|tip Up in the branches of the tree.
...
|tip The turtle is above the inn, at the base of the tree.
...
step
Become the Victim of a Workplace Accident in the Forgegrounds of Dornogal |achieve 40606 |goto Dornogal/0 49.98,61.90
|tip Inside the central building of Dornogal near the Blacksmithing Trainer.
...
step
This guide will take you through the location of all the critters for this achievement, you should use _/tar <critter name>_ once you are at the locations.
|confirm
step
...
|tip You need as many as you have to contribute.
...
step
click Violet Thread
collect Violet Silk Scrap##223901 |goto Azj-Kahet/0 74.83,42.84
step
click Gold Thread
collect collect Gold Silk Scrap##223903 |goto Azj-Kahet/0 73.88,37.75
step
click Crimson Thread
collect Crimson Silk Scrap##223902 |goto 72.68,39.67
step
click "Weaving Supplies"##452708
|tip At the top of the tower.
|tip You must have the 3 different Silk Scraps from the previous steps to open this chest.
...
step
talk Ru'murh##224192
|tip You _must_ have chosen a Severed Threads reputation for the week for _Ru'murh_ to appear.
...
|tip Refer to the respective guides to accomplish this. Navigate to them by clicking here or opening a new guide and searching.
]])
...
|tip The Point of Interest system in your Map will show you all of these.
...
|tip It looks like a blue cluster of crystals in random locations around this area. Location may not be exact.
