...
Private.InstallerData = {
  ...
  Name = Private.Name,
  tutorialImage = 'Interface\\AddOns\\MerfinUI\\Media\\Textures\\logo_wotlk1.png',
...
Private.QuickInstall = function(layout, theme)
  ...
  if not (E.Classic or E.TBC or E.Retail) then
  ...
  if (E.Mists or E.Wrath or E.TBC or E.Retail or E.Classic) and E:IsAddOnEnabled('Cell') then
