...
L = BigWigs:NewBossLocale("ArchimondeHyjal", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Doomwalker", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Hydross the Unstable", "esMX")
if L then
...
L = BigWigs:NewBossLocale("Void Reaver", "esMX")
if L then
