...
The `flag_*.tga` files in this directory are local TGA adaptations of the
country-flag emoji artwork from OpenMoji 17.0.0.
...
- `flag_enUS.tga`: United Kingdom, `1F1EC-1F1E7`
