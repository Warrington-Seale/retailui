...
function MerfinPlus:GetCapabilities()
  ...
  return {
    ...
    raidAssignments = isTBC and type(self.InitializeRaidAssignments) == "function",
    assignmentsOptions = isTBC and type(self.BuildAssignmentsOptions) == "function",
    ...
    assignmentWidgets = isTBC and type(self.InitializeAssignmentWidgets) == "function",
...
function MerfinPlus:OnInitialize()
  ...
  if self.VersionCheckEnable then
