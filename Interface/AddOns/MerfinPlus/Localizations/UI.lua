...
local overrides = {
  deDE = {
    ...
    ["Settings"] = "Einstellungen", ["Pre-Boss Groups"] = "Pre-Boss-Gruppen",
    ["Pre-Boss Groups are not configured yet. This page is reserved for a future update."] =
  ...
  frFR = {
    ...
    ["Settings"] = "Paramètres", ["Pre-Boss Groups"] = "Groupes pré-boss",
    ["Pre-Boss Groups are not configured yet. This page is reserved for a future update."] =
  ...
  esES = {
    ...
    ["Settings"] = "Ajustes", ["Pre-Boss Groups"] = "Grupos pre-jefe",
    ["Pre-Boss Groups are not configured yet. This page is reserved for a future update."] =
  ...
  esMX = {
    ...
    ["Assignments"] = "Asignaciones", ["Media"] = "Medios", ["Profiles"] = "Perfiles",
    ["General Assignments"] = "Asignaciones generales", ["Raid Assignments"] = "Asignaciones de banda",
    ["Settings"] = "Configuración", ["Pre-Boss Groups"] = "Grupos previos al jefe",
    ["Import"] = "Importar", ["Broadcast"] = "Transmitir", ["Delete"] = "Eliminar", ["Copy"] = "Copiar",
  ...
  ptBR = {
    ...
    ["Settings"] = "Configurações", ["Pre-Boss Groups"] = "Grupos pré-chefe",
  ...
  itIT = {
    ...
    ["Settings"] = "Impostazioni", ["Pre-Boss Groups"] = "Gruppi pre-boss",
  ...
  ruRU = {
    ...
    ["Settings"] = "Настройки", ["Pre-Boss Groups"] = "Группы перед боссом",
...
local featureStrings = {
  ...
  ["Import one canonical MFPRA1 snapshot locally. This never sends addon data and does not require a group."] = { deDE = "Importiert lokal einen kanonischen MFPRA1-Snapshot. Es werden keine Addondaten gesendet und keine Gruppe benötigt.", frFR = "Importe localement un instantané MFPRA1 canonique sans envoyer de données ni nécessiter de groupe.", esES = "Importa localmente una instantánea MFPRA1 canónica sin enviar datos ni requerir grupo.", ptBR = "Importa localmente um snapshot MFPRA1 canônico sem enviar dados nem exigir grupo.", itIT = "Importa localmente uno snapshot MFPRA1 canonico senza inviare dati né richiedere un gruppo.", ruRU = "Локально импортирует канонический снимок MFPRA1 без отправки данных и без требования группы.", zhCN = "在本地导入一个规范MFPRA1快照，不发送插件数据，也不需要队伍。", zhTW = "在本機匯入一個標準MFPRA1快照，不傳送插件資料，也不需要隊伍。", koKR = "표준 MFPRA1 스냅샷 하나를 로컬로 가져옵니다. 애드온 데이터를 보내지 않으며 파티가 필요하지 않습니다.", jaJP = "正規MFPRA1スナップショットをローカルにインポートします。アドオンデータは送信せず、グループも不要です。" },
  ["Explicitly broadcast the complete MFPRA1 assignment and Boss Plan snapshot."] = { deDE = "Sendet ausdrücklich den vollständigen MFPRA1-Zuweisungs- und Bossplan-Snapshot.", frFR = "Diffuse explicitement l’instantané complet des affectations et plans de boss MFPRA1.", esES = "Transmite explícitamente la instantánea completa de asignaciones y planes MFPRA1.", ptBR = "Transmite explicitamente o snapshot completo de atribuições e planos MFPRA1.", itIT = "Trasmette esplicitamente lo snapshot completo di assegnazioni e piani MFPRA1.", ruRU = "Явно рассылает полный снимок назначений и планов боссов MFPRA1.", zhCN = "明确广播完整的MFPRA1任务和首领计划快照。", zhTW = "明確廣播完整的MFPRA1指派和首領計畫快照。", koKR = "전체 MFPRA1 임무 및 우두머리 계획 스냅샷을 명시적으로 전송합니다.", jaJP = "完全なMFPRA1割り当て・ボスプランのスナップショットを明示的に配信します。" },
  ...
  ["Select a raid and import an MFPRA1 snapshot with a Boss Plan to enable this button."] = { deDE = "Wähle einen Raid und importiere einen MFPRA1-Snapshot mit Bossplan, um diese Schaltfläche zu aktivieren.", frFR = "Sélectionnez un raid et importez un instantané MFPRA1 avec plan de boss pour activer ce bouton.", esES = "Selecciona una banda e importa una instantánea MFPRA1 con plan para activar este botón.", ptBR = "Selecione um raide e importe um snapshot MFPRA1 com plano para ativar este botão.", itIT = "Seleziona un raid e importa uno snapshot MFPRA1 con piano per attivare il pulsante.", ruRU = "Выберите рейд и импортируйте снимок MFPRA1 с планом босса, чтобы включить кнопку.", zhCN = "选择团队副本并导入含首领计划的MFPRA1快照以启用此按钮。", zhTW = "選擇團隊副本並匯入含首領計畫的MFPRA1快照以啟用此按鈕。", koKR = "공격대를 선택하고 우두머리 계획이 포함된 MFPRA1 스냅샷을 가져오면 이 버튼이 활성화됩니다.", jaJP = "レイドを選択し、ボスプラン付きMFPRA1スナップショットをインポートすると有効になります。" },
  ["Open the complete imported MFPRA1 Boss Plan for the selected boss."] = { deDE = "Öffnet den vollständig importierten MFPRA1-Bossplan für den ausgewählten Boss.", frFR = "Ouvre le plan de boss MFPRA1 complet importé pour le boss sélectionné.", esES = "Abre el plan MFPRA1 completo importado para el jefe seleccionado.", ptBR = "Abre o plano MFPRA1 completo importado para o chefe selecionado.", itIT = "Apre il piano MFPRA1 completo importato per il boss selezionato.", ruRU = "Открывает полный импортированный план MFPRA1 для выбранного босса.", zhCN = "打开所选首领的完整已导入MFPRA1首领计划。", zhTW = "開啟所選首領的完整已匯入MFPRA1首領計畫。", koKR = "선택한 우두머리의 전체 가져온 MFPRA1 우두머리 계획을 엽니다.", jaJP = "選択したボスのインポート済み完全MFPRA1ボスプランを開きます。" },
  ["No imported MFPRA1 Boss Plan is available for the selected raid and boss."] = { deDE = "Für den ausgewählten Raid und Boss ist kein importierter MFPRA1-Bossplan verfügbar.", frFR = "Aucun plan de boss MFPRA1 importé n’est disponible pour ce raid et ce boss.", esES = "No hay ningún plan MFPRA1 importado para la banda y el jefe seleccionados.", ptBR = "Nenhum plano MFPRA1 importado está disponível para o raide e chefe selecionados.", itIT = "Nessun piano MFPRA1 importato è disponibile per il raid e il boss selezionati.", ruRU = "Для выбранного рейда и босса нет импортированного плана MFPRA1.", zhCN = "所选团队副本和首领没有可用的已导入MFPRA1计划。", zhTW = "所選團隊副本和首領沒有可用的已匯入MFPRA1計畫。", koKR = "선택한 공격대와 우두머리에 가져온 MFPRA1 계획이 없습니다.", jaJP = "選択したレイドとボスに利用可能なインポート済みMFPRA1プランがありません。" },
  ...
  ["Receiver rejected MFPRA1 transfer: %s"] = { deDE = "Empfänger lehnte die MFPRA1-Übertragung ab: %s", frFR = "Le destinataire a refusé le transfert MFPRA1 : %s", esES = "El receptor rechazó la transferencia MFPRA1: %s", ptBR = "O destinatário rejeitou a transferência MFPRA1: %s", itIT = "Il destinatario ha rifiutato il trasferimento MFPRA1: %s", ruRU = "Получатель отклонил передачу MFPRA1: %s", zhCN = "接收者拒绝MFPRA1传输：%s", zhTW = "接收者拒絕MFPRA1傳輸：%s", koKR = "수신자가 MFPRA1 전송을 거부했습니다: %s", jaJP = "受信者がMFPRA1転送を拒否しました: %s" },
  ...
  ["Invalid MFPRA1 Raid Assignments string."] = { deDE = "Ungültiger MFPRA1-Raid-Zuweisungsstring.", frFR = "Chaîne d’affectations de raid MFPRA1 invalide.", esES = "Cadena MFPRA1 de asignaciones de banda no válida.", ptBR = "String MFPRA1 de atribuições de raide inválida.", itIT = "Stringa MFPRA1 delle assegnazioni raid non valida.", ruRU = "Недопустимая строка назначений рейда MFPRA1.", zhCN = "无效的MFPRA1团队任务字符串。", zhTW = "無效的MFPRA1團隊指派字串。", koKR = "잘못된 MFPRA1 공격대 임무 문자열입니다.", jaJP = "無効なMFPRA1レイド割り当て文字列です。" },
  ["Identical MFPRA1 snapshot selected locally. Nothing was sent."] = { deDE = "Identischer MFPRA1-Snapshot lokal ausgewählt. Nichts wurde gesendet.", frFR = "Instantané MFPRA1 identique sélectionné localement. Rien n’a été envoyé.", esES = "Instantánea MFPRA1 idéntica seleccionada localmente. No se envió nada.", ptBR = "Snapshot MFPRA1 idêntico selecionado localmente. Nada foi enviado.", itIT = "Snapshot MFPRA1 identico selezionato localmente. Nulla è stato inviato.", ruRU = "Локально выбран идентичный снимок MFPRA1. Ничего не отправлено.", zhCN = "已在本地选择相同MFPRA1快照，未发送任何内容。", zhTW = "已在本機選擇相同MFPRA1快照，未傳送任何內容。", koKR = "동일한 MFPRA1 스냅샷을 로컬에서 선택했습니다. 전송된 내용은 없습니다.", jaJP = "同一のMFPRA1スナップショットをローカルで選択しました。送信はありません。" },
  ["MFPRA1 Raid Assignments imported locally. Nothing was sent."] = { deDE = "MFPRA1-Raid-Zuweisungen lokal importiert. Nichts wurde gesendet.", frFR = "Affectations de raid MFPRA1 importées localement. Rien n’a été envoyé.", esES = "Asignaciones MFPRA1 importadas localmente. No se envió nada.", ptBR = "Atribuições MFPRA1 importadas localmente. Nada foi enviado.", itIT = "Assegnazioni raid MFPRA1 importate localmente. Nulla è stato inviato.", ruRU = "Назначения рейда MFPRA1 импортированы локально. Ничего не отправлено.", zhCN = "已在本地导入MFPRA1团队任务，未发送任何内容。", zhTW = "已在本機匯入MFPRA1團隊指派，未傳送任何內容。", koKR = "MFPRA1 공격대 임무를 로컬로 가져왔습니다. 전송된 내용은 없습니다.", jaJP = "MFPRA1レイド割り当てをローカルにインポートしました。送信はありません。" },
  ...
  ["Import an MFPRA1 Boss Plan first."] = { deDE = "Importiere zuerst einen MFPRA1-Bossplan.", frFR = "Importez d’abord un plan de boss MFPRA1.", esES = "Importa primero un plan MFPRA1.", ptBR = "Importe primeiro um plano MFPRA1.", itIT = "Importa prima un piano MFPRA1.", ruRU = "Сначала импортируйте план босса MFPRA1.", zhCN = "请先导入MFPRA1首领计划。", zhTW = "請先匯入MFPRA1首領計畫。", koKR = "먼저 MFPRA1 우두머리 계획을 가져오세요.", jaJP = "先にMFPRA1ボスプランをインポートしてください。" },
}
...
function MerfinPlus:LocalizeRaidAssignmentStatus(value)
  ...
  local patterns = {
    ...
    { "^Receiver rejected MFPRA1 transfer: (.-)$", "Receiver rejected MFPRA1 transfer: %s" },
