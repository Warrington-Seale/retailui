...
local colors = {
  field = { 0.025, 0.028, 0.030, 0.98 },
  row = { 0.04, 0.043, 0.046, 0.98 },
  hover = { 0.115, 0.095, 0.045, 1 },
  border = { 0.86, 0.58, 0.08, 0.95 },
  borderSoft = { 0.26, 0.26, 0.23, 0.9 },
  text = { 0.96, 0.96, 0.93, 1 },
  muted = { 0.58, 0.58, 0.54, 1 },
...
local function Constructor()
  ...
  title:SetTextColor(1, 0.76, 0.12, 1)
  title:Hide()
  ...
  local raidDropdownArrow = raidDropdown:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
  raidDropdownArrow:SetPoint("RIGHT", raidDropdown, "RIGHT", -10, 0)
  raidDropdownArrow:SetText("v")
  raidDropdownArrow:SetTextColor(colors.border[1], colors.border[2], colors.border[3], 1)
