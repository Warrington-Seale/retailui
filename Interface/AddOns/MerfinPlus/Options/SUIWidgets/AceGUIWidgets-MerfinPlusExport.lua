...
local actionButtonColors = {
  normal = {
    background = { 0.035, 0.039, 0.043, 1 },
    border = { 0.86, 0.58, 0.08, 0.9 },
    text = { 0.96, 0.96, 0.93, 1 },
  },
  hover = {
    background = { 0.10, 0.078, 0.026, 1 },
    border = { 1, 0.72, 0.14, 1 },
    text = { 1, 0.91, 0.58, 1 },
  },
  pressed = {
    background = { 0.17, 0.11, 0.018, 1 },
    border = { 1, 0.84, 0.28, 1 },
    text = { 1, 0.82, 0.35, 1 },
  },
  disabled = {
...
local function ExportEditConstructor()
  ...
  SetBackdrop(scrollBG, { 0.018, 0.021, 0.023, 1 }, { 0.86, 0.58, 0.08, 0.9 })
...
local function CopyButtonConstructor()
  ...
  button:SetWidth(82)
  SetBackdrop(button, { 0.035, 0.039, 0.043, 1 }, { 0.86, 0.58, 0.08, 0.9 })
