...
local EXMRH_PYTHON_DATA = {
    RankTable = {
        { label = "0.1%", score = 4164.57, count = 1518 },
        { label = "1%", score = 3924.33, count = 15188 },
        { label = "10%", score = 3479.08, count = 151881 },
        { label = "25%", score = 3220.78, count = 379703 },
        { label = "40%", score = 3023.40, count = 607525 },
        { label = "47.70%", score = 2920.00, count = 724481 },
        { label = "50%", score = 2873.23, count = 759406 },
        { label = "59.50%", score = 2680.00, count = 903702 },
        { label = "60%", score = 2666.68, count = 911287 },
        { label = "64.00%", score = 2560.00, count = 972041 },
        { label = "68.60%", score = 2320.00, count = 1041907 },
        { label = "70%", score = 2226.67, count = 1063169 },
        { label = "70.40%", score = 2200.00, count = 1069246 },
        { label = "71.90%", score = 2080.00, count = 1092029 },
        { label = "75.10%", score = 1840.00, count = 1140629 },
        { label = "76.30%", score = 1720.00, count = 1158856 },
        { label = "79.20%", score = 1480.00, count = 1202900 },
        { label = "80.50%", score = 1360.00, count = 1222646 },
        { label = "82.50%", score = 1240.00, count = 1253021 },
    },
    TotalPopulation = 1518813,
    DataTime = "2026.07.06 22:39",
    ExwindVersion = "v26.7.6.2239",
}
-- [[ PYTHON_DATA_END ]]
