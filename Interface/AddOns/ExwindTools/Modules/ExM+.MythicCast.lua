...
function ExwindTools.GetMythicCastTargetIndicatorAtlasOptions()
    local items = {}
...
local function EX_RegisterLayout()
    local layout = {
        ...
        { key = "enabled", type = "checkbox", x = 1, y = 12, w = 6, h = 2, label = L["启用"] },
        { key = "locked", type = "checkbox", x = 10, y = 12, w = 8, h = 2, label = L["锁定位置"] },
        { key = "preview", type = "checkbox", x = 20, y = 12, w = 8, h = 2, label = L["预览模式"] },
        { key = "btn_reset_pos", type = "button", x = 34, y = 12, w = 14, h = 2, label = L["重置位置"] },
        { key = "posX", type = "slider", x = 1, y = 16, w = 17, h = 2, label = L["整体水平位置"], min = -1000, max = 1000 },
        { key = "posY", type = "slider", x = 21, y = 16, w = 17, h = 2, label = L["整体垂直位置"], min = -1000, max = 1000 },
        { key = "hideLevel92Casts", type = "checkbox", x = 1, y = 18, w = 14, h = 2, label = L["隐藏92级读条"] },

        { key = "custom_attach_header", type = "header", x = 1, y = 21, w = 53, h = 2, label = L["自由依附 (Beta)"], labelSize = 20 },
        { key = "custom_attach_desc", type = "description", x = 1, y = 24, w = 48, h = 1, label = L["开启后可将施法条组依附于任意 UI 元素。若目标框体不存在，将自动对齐到屏幕中心。"] },
        { key = "attachToCustom", type = "checkbox", x = 1, y = 26, w = 10, h = 2, label = L["启用自由依附"] },
        { key = "customAttachTarget", type = "input", x = 12, y = 26, w = 26, h = 2, label = L["当前目标路径"] },
        { key = "btn_pick_frame", type = "button", x = 39, y = 26, w = 10, h = 2, label = L["鼠标选取"] },

        { key = "raid_header", type = "header", x = 1, y = 30, w = 53, h = 2, label = L["团队标记"], labelSize = 20 },
        { key = "showRaidIcon", type = "checkbox", x = 1, y = 33, w = 12, h = 2, label = L["显示团队标记"] },
        { key = "raidIconSize", type = "slider", x = 15, y = 33, w = 12, h = 2, label = L["标记大小"], min = 10, max = 64 },
        { key = "showPlayerTargetIndicator", type = "checkbox", x = 29, y = 33, w = 18, h = 2, label = L["玩家目标提示"] },
        { key = "playerTargetIndicatorAtlas", type = "dropdown", x = 1, y = 36, w = 24, h = 2, label = L["提示材质"], items = "func:ExwindTools.GetMythicCastTargetIndicatorAtlasOptions()" },
        { key = "raidIconX", type = "slider", x = 28, y = 36, w = 11, h = 2, label = L["水平偏移"], min = -100, max = 100 },
        { key = "raidIconY", type = "slider", x = 41, y = 36, w = 11, h = 2, label = L["垂直偏移"], min = -100, max = 100 },
        { key = "playerTargetIndicatorSize", type = "slider", x = 1, y = 39, w = 15, h = 2, label = L["提示大小"], min = 8, max = 64 },
        { key = "playerTargetIndicatorX", type = "slider", x = 19, y = 39, w = 15, h = 2, label = L["提示X偏移"], min = -100, max = 100 },
        { key = "playerTargetIndicatorY", type = "slider", x = 37, y = 39, w = 15, h = 2, label = L["提示Y偏移"], min = -100, max = 100 },

        { key = "color_header", type = "header", x = 1, y = 43, w = 53, h = 2, label = L["计时条外观"], labelSize = 20 },
        { key = "displayMode", type = "dropdown", x = 1, y = 46, w = 20, h = 2, label = L["显示模式"], items = {
            { L["进度条模式"], "bar" },
            { L["图标模式"],   "icon" },
        } },
        { key = "iconModeSize", type = "slider", x = 24, y = 46, w = 14, h = 2, label = L["图标尺寸"], min = 20, max = 80 },
        { key = "iconModeTimerSize", type = "slider", x = 40, y = 46, w = 12, h = 2, label = L["秒数字号"], min = 8, max = 32 },
        { key = "nonInterruptColor", type = "color", x = 21, y = 50, w = 15, h = 2, label = L["无法打断颜色"], labelPos = "top" },
        { key = "spacing", type = "slider", x = 1, y = 50, w = 17, h = 2, label = L["垂直间距"], min = 0, max = 50 },
        { key = "growDirection", type = "dropdown", x = 21, y = 53, w = 15, h = 2, label = L["增长方向"], items = "向下,向上" },
        { key = "maxBars", type = "slider", x = 1, y = 53, w = 17, h = 2, label = L["最大显示数量"], min = 1, max = 15 },
        { key = "timerGroup", type = "timerBarGroup", x = 1, y = 57, w = 53, h = 26, label = "", labelSize = 20 },

        { key = "font_spell_header", type = "header", x = 1, y = 83, w = 53, h = 2, label = L["字体：法术说明"], labelSize = 20 },
        { key = "textAlign", type = "dropdown", x = 1, y = 87, w = 15, h = 2, label = L["对齐方式"], items = "LEFT,CENTER,RIGHT" },
        { key = "font_spell", type = "fontgroup", x = 1, y = 90, w = 53, h = 17, label = "", labelSize = 20 },

        { key = "font_target_header", type = "header", x = 1, y = 110, w = 47, h = 2, label = L["字体：施法目标"], labelSize = 20 },
        { key = "showTarget", type = "checkbox", x = 1, y = 114, w = 15, h = 2, label = L["显示目标姓名"] },
        { key = "targetAlign", type = "dropdown", x = 18, y = 114, w = 15, h = 2, label = L["对齐方式"], items = "LEFT,CENTER,RIGHT" },
        { key = "mergeTargetIntoSpellName", type = "checkbox", x = 1, y = 118, w = 14, h = 2, label = L["并入法术名称"] },
        { key = "spellTargetInlineFormat", type = "input", x = 18, y = 118, w = 15, h = 2, label = L["中间分隔符"], placeholder = "-" },
        { key = "font_target", type = "fontgroup", x = 1, y = 120, w = 53, h = 18, label = "", labelSize = 20 },

        { key = "font_timer_header", type = "header", x = 1, y = 138, w = 53, h = 2, label = L["字体：冷却时间"], labelSize = 20 },
        { key = "showTimer", type = "checkbox", x = 1, y = 142, w = 15, h = 2, label = L["显示时间文字"] },
        { key = "timerAlign", type = "dropdown", x = 18, y = 142, w = 15, h = 2, label = L["对齐方式"], items = "LEFT,CENTER,RIGHT" },
        { key = "font_timer", type = "fontgroup", x = 1, y = 145, w = 53, h = 18, label = "", labelSize = 20 },
    }
...
local function UpdateBarVisuals(bar)
    ...
    if bar.PlayerTargetIndicator then
        ...
        bar.PlayerTargetIndicator:SetPoint("CENTER", bar.PlayerTargetIndicatorFrame or bar, "CENTER", db.playerTargetIndicatorX or 0, db.playerTargetIndicatorY or 0)
    ...
    if isIconMode then
        ...
        if bar.Cooldown then bar.Cooldown:SetHideCountdownNumbers(true); bar.Cooldown:Clear() end
...
local function SchedulePlayerTargetIndicatorRecheck(bar, unit)
    if not C_Timer or not bar or bar._isPreview or not unit then return end

    local token = (bar._playerTargetRecheckToken or 0) + 1
    bar._playerTargetRecheckToken = token

    C_Timer.After(0.1, function()
        if not bar or bar._playerTargetRecheckToken ~= token then return end
        if not EX_DB.enabled or isPreviewing or not UnitExists(unit) then return end
        if bar.unit ~= unit or activeBars[unit] ~= bar then return end
        if not (UnitCastingDuration(unit) or UnitChannelDuration(unit)) then return end
...
UpdateCast = function(unit, allowCombatRecheck)
    ...
    UpdatePlayerTargetIndicator(bar, unit)
    SchedulePlayerTargetIndicatorRecheck(bar, unit)
    ...
    if EX_DB.displayMode == "icon" and bar.TimerText then
        ...
        bar:SetScript("OnUpdate", function(self)
            if not self.unit then self:SetScript("OnUpdate", nil); return end
            local endTime = ReadEndTime(self.unit)
            if not endTime then self:SetScript("OnUpdate", nil); return end
...
local function CreateAnchor()
    ...
    anchorFrame:SetScript("OnMouseDown", function(self, button)
        if button == "LeftButton" and not EX_DB.locked then
            local onDragStart = self:GetScript("OnDragStart")
            if type(onDragStart) == "function" then
                onDragStart(self)
            end
        end
