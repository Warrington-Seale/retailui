...
L["Create Healers indicator"] = "Healers-Indikator erstellen"
...
L["nonPlayerAuras"] = "Nur Nicht-Spieler-Auren anzeigen"
L["nonPlayerAurasTip"] = "Zeigt nur Debuffs, die nicht von einem Spieler oder Spieler-Pet kommen.|Spieler-Effekte wie Erschöpfung, Vorahnung und Zeitverzerrung werden ausgeblendet. Die meisten Dungeon- und Raid-Debuffs bleiben sichtbar.|Im PvP solltest du das auslassen."
L["Dispels"] = "Dispels"
...
L["GHOST"] = "GEIST"
L["Glow"] = "Leuchten"
L["glowDisabledApiWarning"] = "Leider ist Leuchten zurzeit nicht umsetzbar (API-Änderungen). Ich habe den Indikator vorerst deaktiviert, bis eine Lösung gefunden ist."
L["crowdControlsApiWarning"] = "Cell kann keine eigene CC-Liste mehr verwenden. Blizzard entscheidet, welche Debuffs Massenkontrolle sind. Dieser Indikator zeigt diese automatisch an."
...
L["Icons only"] = "Nur Symbol"
L["Glow only"] = "Nur Leuchten"
L["Both"] = "Beides"
...
L["keepInHealers"] = "Im Healers-Indikator behalten"
L["keepInHealersTip"] = "Wenn aktiv, bleibt dieser Buff zusätzlich im Healers-Indikator sichtbar.|Wenn deaktiviert, erscheint er nur hier und wird aus Healers entfernt."
