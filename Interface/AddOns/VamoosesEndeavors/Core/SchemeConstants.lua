-- ============================================================================
-- Vamoose's Endeavors - Color Schemes
-- VE's local copy of the shared scheme master at
-- Project Documentation/Reference/schemecolors.lua -- that file is the
-- cross-addon source of truth and is never edited; VE-local scheme changes
-- belong here instead.
-- Defines the VAMOOSE_SchemeConstants global that Core/Constants.lua reads.
-- ============================================================================
...
VAMOOSE_SchemeConstants = {
    ...
    -- ========================================================================
    -- Colorblind Safe: CVD-friendly palette
    -- Based on David Math Logic colorblind-safe palette
    -- All semantic colors distinguishable across deuteranopia, protanopia,
    -- and tritanopia. Uses blue/teal/amber/pink instead of green/red.
    -- ========================================================================
    ColorblindSafe = {
        -- Containers (neutral dark, high contrast base)
        bg              = {r=0.10, g=0.11, b=0.12, a=0.95}, -- #1a1c1e
        panel           = {r=0.14, g=0.15, b=0.16, a=1.00}, -- #232628
        border          = {r=0.35, g=0.38, b=0.40, a=1.00}, -- #596166

        -- Typography (WCAG AA+ on dark bg)
        text            = {r=0.89, g=0.91, b=0.94, a=1.00}, -- #e2e8f0 (~12.6:1)
        text_header     = {r=0.96, g=0.97, b=0.98, a=1.00}, -- #f5f8fa (~16:1)
        text_dim        = {r=0.64, g=0.67, b=0.71, a=1.00}, -- #a3abb5 (~5.8:1)
        text_muted      = {r=0.80, g=0.84, b=0.88, a=1.00}, -- #ccd6e0 (~9.3:1)

        -- Buttons
        button_normal   = {r=0.18, g=0.19, b=0.20, a=1.00}, -- #2e3133
        button_hover    = {r=0.24, g=0.26, b=0.28, a=1.00}, -- #3d4247
        button_active   = {r=0.12, g=0.13, b=0.14, a=1.00}, -- #1f2123
        button_inactive = {r=0.18, g=0.19, b=0.20, a=0.40}, -- #2e3133 @ 40%

        -- Interactive Text
        button_text_norm  = {r=0.89, g=0.91, b=0.94, a=1.00}, -- #e2e8f0
        button_text_hover = {r=1.00, g=1.00, b=1.00, a=1.00}, -- #ffffff
        button_text_dis   = {r=0.50, g=0.53, b=0.56, a=1.00}, -- #80878e

        -- Semantic (colorblind-safe palette)
        accent          = {r=0.12, g=0.53, b=0.90, a=1.00}, -- #1E88E5 (Blue)
        success         = {r=0.00, g=0.60, b=0.54, a=1.00}, -- #00998A (Bright Teal)
        warning         = {r=1.00, g=0.76, b=0.03, a=1.00}, -- #FFC107 (Amber)
        error           = {r=0.85, g=0.11, b=0.38, a=1.00}, -- #D81B60 (Deep Pink)
